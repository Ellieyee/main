...
Format: `edit [INDEX OF STUDENT] n/[ORIGINAL_STUDENT] n/[EDITED_STUDENT_NAME]`

Example:

* `edit 1 n/Ben n/Ben Leong`
...
* `addAssignment` tn/TUTORIAL NAME m/MODULE CODE n/ASSIGNMENT NAME score/MAX SCORE sd/START DATE ed/END DATE
****
...
* You can use either tutorial index or tutorial name with module code to specify the Tutorial.
* This will be in the format:
* `listEvents` tn/TUTORIAL NAME m/MODULE CODE
****
