...
include:: https://github.com/Ellieyee/main/blob/master/docs/UserGuide.adoc#deleting-a-module-deletemodule

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#deleting-a-tutorial-deletetutorial

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#deleting-a-student-deletestudent

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#editing-a-student-edit

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#searching-student-by-name-find

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#listing-students-from-a-tutorial-list

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#display-tutorial-class-test-results-displayassignmentscore

include :: https://github.com/Ellieyee/main/blob/master/docs/UserGuide.adoc#display-tutorial-class-assignments-displayassignments

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#display-tutorial-class-attendance-displayattendance

include:: https://github.com/Ellieyee/main/blob/pp-update/docs/UserGuide.adoc#changing-the-ui-tab-cd
...
include :: https://github.com/Ellieyee/main/blob/master/docs/DeveloperGuide.adoc#Design-Ui

include:: https://github.com/Ellieyee/main/blob/master/docs/DeveloperGuide.adoc#edit-feature

include:: https://github.com/Ellieyee/main/blob/master/docs/DeveloperGuide.adoc#list-feature
